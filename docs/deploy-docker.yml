...
description: >
  Deploy logstream-server with Docker Compose, an Nginx reverse proxy container,
  and automatic HTTPS via a Certbot container.
---
...
Install [Docker Desktop](https://www.docker.com/products/docker-desktop/) and ensure it is running before continuing.
